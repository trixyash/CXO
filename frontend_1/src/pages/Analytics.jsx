    ...
    <div className="min-h-screen bg-[#f4f7f5]">
      ...
      >
        <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-50">
          ...
          <motion.div animate={{ opacity: isSidebarOpen ? 1 : 0, width: isSidebarOpen ? 'auto' : 0 }} transition={{ duration: 0.2 }} className="overflow-hidden whitespace-nowrap flex flex-col"
          >
